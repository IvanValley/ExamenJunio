...
public abstract class Animal {
    ...
    /**
     * ¿Qué hace la clase animal?
     * 
     * @method Inicializa un objeto Animal recién creado a partir de un código identificativo, su fecha de nacimiento, su sexo y su peso.
     * @param codigo Código identificativo del animal. 
     * Tiene que ser una cadena formada por exactamente cinco caracteres alfanuméricos entre el '0' y el '9' o la 'a' y la 'z' en minúsculas.
     * @param fechaNacimiento Cadena conteniendo la fecha que se quiere asignar al animal como fecha de nacimiento. 
     * La cadena deberá de seguir el siguiente formato: 
     * - Un número de dos cifras que represente el día del mes. Si el día solo tiene una cifra, deberá ponerse un 0 delante. 
